...
(* OASIS_START *)
(* DO NOT EDIT (digest: d2f5210e230cd74b3f2a8d1bffc25665) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("inotify_lwt",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_inotify_lwt", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "A\225\249n\250\243q\247\134\231\199-\164\213\182^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
